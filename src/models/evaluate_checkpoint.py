"""DEV-only evaluation for service, parent, intent, and priority checkpoints."""
...
def evaluate(
    ...
    if data_path is None:
        data_path = ROOT / "data" / "splits" / "dev.csv"
    if data_path.name != "dev.csv":
        raise ValueError("This evaluator is deliberately restricted to dev.csv")
    ...
    if frame.empty:
        raise ValueError("No DEV rows matched the requested scope")

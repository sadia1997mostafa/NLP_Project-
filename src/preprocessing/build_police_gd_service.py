...
PARENTS = [
    ...
    parent("POLICE_GD_FILING", "GD Filing and Submission", "Preparing and submitting a General Diary complaint, including information, attachments and jurisdiction.", ["Filing process", "Online submission", "Required information", "Attachments", "Jurisdiction"], [
        ...
        leaf("POLICE_GD_IDENTITY_REQUIREMENTS", "Online GD Identity and Registration Requirements", "Identity and contact requirements for using the online GD service.", ["Identity needed for online GD", "Registration requirements"], ["Incident supporting documents", "Providing real identifiers in pilot text"], ["অনলাইন জিডি ব্যবহারে পরিচয় যাচাইয়ের জন্য কী প্রয়োজন?", "Online GD register করতে কোন identity information লাগে?", "GD account registration er requirements ki ki?", "complaint submit করার আগে user verification-এর কী কী step আছে জানতে চাই।"] ),
    ]),
    parent("POLICE_GD_INCIDENT_TYPE", "GD Incident and Item Type", "The kind of loss, theft, found property or other incident the citizen wants recorded.", ["Lost document", "Lost item", "Stolen item", "Found property", "Other incident"], [
        ...
        leaf("POLICE_GD_STOLEN_ITEM", "Stolen Item GD/Complaint", "Reporting property believed to have been stolen.", ["Stolen item complaint", "Theft report through portal"], ["Merely misplaced item", "Emergency in progress"], ["জিনিস চুরি হলে অনলাইন অভিযোগ বা জিডি কীভাবে করব?", "আমার phone stolen হয়েছে, police portal-এ report দিতে চাই।", "churi jawa item er complaint kivabe submit korbo?", "বাজারে থাকা অবস্থায় wallet চুরি হয়েছে—online report-এর category কোনটি?"], priority="Medium", pilot_review=True),
        leaf("POLICE_GD_FOUND_ITEM", "Found Item Report", "Reporting property the citizen found and wants to notify police about.", ["Report found property", "Found item GD"], ["Recovering the citizen's lost property", "Stolen-item complaint"], ["কুড়িয়ে পাওয়া জিনিস পুলিশের কাছে কীভাবে রিপোর্ট করব?", "একটা lost phone পেয়েছি, GD portal-এ জানানো যাবে?", "found item report online e kivabe dibo?", "রাস্তায় একটি ব্যাগ পেয়েছি—প্রাপ্তি সংক্রান্ত complaint কোথায় submit করব?"], priority="Medium"),
        leaf("POLICE_GD_OTHER_INCIDENT", "Other Non-Emergency GD Complaint", "A non-emergency complaint that does not fit the supported lost/stolen/found item groups.", ["Other GD complaint", "Non-emergency incident report"], ["Unknown/OOD question", "Immediate danger"], ["হারানো বা প্রাপ্তি ছাড়া অন্য বিষয়ে জিডির অভিযোগ কীভাবে দেব?", "একটা non-emergency incident police record-এ জানাতে চাই।", "other complaint category diye GD submit korbo kivabe?", "ঘটনাটি lost item নয়, তবু লিখিতভাবে পুলিশকে জানাতে portal ব্যবহার করতে চাই।"], priority="Medium", pilot_review=True, evidence_status="needs_pilot_validation"),
    ]),
    parent("POLICE_GD_ONLINE_ACCOUNT", "Online GD Account and Access", "Account registration, login, password, OTP, verification and general access problems.", ["Account registration", "Login", "Password", "OTP", "Identity verification", "Access problem"], [
        ...
        leaf("POLICE_GD_ACCOUNT_ACCESS_PROBLEM", "General Online GD Account Access Problem", "An existing account cannot be accessed and no specific credential cause is clear.", ["Cannot access GD account", "Unknown account error"], ["Known password issue", "OTP-specific issue"], ["সঠিক তথ্য দিয়েও অনলাইন জিডি অ্যাকাউন্টে ঢুকতে পারছি না।", "GD account open হচ্ছে না, clear errorও দেখাচ্ছে না।", "online GD access hocche na, reason bujhte parchi na.", "login দিলে page আবার শুরুতে চলে আসে—account access কীভাবে ঠিক করব?"], priority="Medium", pilot_review=True),
    ]),
    ...
    parent("POLICE_GD_TECHNICAL_PROBLEMS", "Online GD Technical Problems", "Submission failures and portal-level availability problems.", ["Submission failure", "Portal unavailable"], [
        ...
        leaf("POLICE_GD_PORTAL_UNAVAILABLE", "Online GD Portal Unavailable", "The GD website or app itself does not load or appears unavailable.", ["GD portal down", "App not opening"], ["One complaint submission failure", "Known login problem"], ["অনলাইন জিডি ওয়েবসাইট না খুললে কী করব?", "GD app load হচ্ছে না।", "online GD portal down dekhacche.", "বিভিন্ন page try করেও service খুলছে না—system availability কোথায় report করব?"], priority="Medium"),
    ]),
